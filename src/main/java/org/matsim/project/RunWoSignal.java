...
//
    ...
    public static void main(String[] args) {
        RunWoSignal r = new RunWoSignal();
        try {
            r.run_MATSim(1,  "D:\\MATSim\\LA_large\\SignalSim\\lametro\\novateur\\test_1_no_sig_half_pop\\input\\config.xml"); // 2 should be 1st iteration
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } catch (Exception e) {
