...
//		}
        ...
        //iter 1
        //double ExpressFactor [] = {0.4061212471220624, 0.5232528516660481, 0.6109978913543621, 0.5088216036676481, 1.2342093113217012};
        //iter 2
        //double ExpressFactor[] = {0.39076393537088, 0.5649955451484352, 0.6941633660540125, 0.5240004965855082, 0.9125959588309432};
        //iter 3
        //double ExpressFactor[] = {0.381544733043619, 0.5907178221581815, 0.7474165921695615, 0.5472491354496656, 0.6981780358264403};
        //iter 4
        //double ExpressFactor[] = {0.37253571352539316, 0.6176675611948905, 0.810203824706733, 0.5576263633235667, 0.5344538953423275};
...
//
    ...
    public static void main(String[] args) {
        ...
        try {
            //r.run_MATSim(1,  "D:\\MATSim\\LA_large\\SignalSim\\lametro\\calibration\\new_pop\\config_basemodel.xml"); // 2 should be 1st iteration
            r.run_MATSim(1,  "D:\\HAYSTAC\\Test with SCAG data\\matsim plan config\\config_scag_assign.xml"); // 2 should be 1st iteration
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } catch (Exception e) {
