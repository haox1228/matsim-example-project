...
public class RunCreateNetworkSHP {
    ...
    public static void main(String[] args) {
        ...
        config.network().setInputFile("D:\\MATSim\\LA_large\\SignalSim\\lametro\\haoxuanfinalproject\\filtered_network.xml");
        Scenario scenario = ScenarioUtils.loadScenario(config);
        Network network = scenario.getNetwork();

        CoordinateReferenceSystem crs = MGC.getCRS("EPSG:6423");    // EPSG Code for Swiss CH1903_LV03 coordinate system
        ...
        ShapeFileWriter.writeGeometries(features, "D:\\MATSim\\LA_large\\SignalSim\\lametro\\haoxuanfinalproject\\links.shp");
        ...
        ShapeFileWriter.writeGeometries(features, "D:\\MATSim\\LA_large\\SignalSim\\lametro\\haoxuanfinalproject\\node.shp");
    }
}
